...
import 'transactions_page1_model.dart';
export 'transactions_page1_model.dart';

class TransactionsPage1Widget extends StatefulWidget {
  const TransactionsPage1Widget({super.key});

  @override
  State<TransactionsPage1Widget> createState() =>
      _TransactionsPage1WidgetState();
}

class _TransactionsPage1WidgetState extends State<TransactionsPage1Widget> {
  late TransactionsPage1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionsPage1Model());
  }

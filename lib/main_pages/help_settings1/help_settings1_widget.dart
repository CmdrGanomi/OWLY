...
import 'help_settings1_model.dart';
export 'help_settings1_model.dart';

class HelpSettings1Widget extends StatefulWidget {
  const HelpSettings1Widget({super.key});

  @override
  State<HelpSettings1Widget> createState() => _HelpSettings1WidgetState();
}

class _HelpSettings1WidgetState extends State<HelpSettings1Widget> {
  late HelpSettings1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HelpSettings1Model());
  }
                  ...
                  Flexible(
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed('PrivacyPage1');
                        },
                        text: 'Privacy Policy',
                        options: FFButtonOptions(

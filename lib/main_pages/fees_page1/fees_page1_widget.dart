...
import 'fees_page1_model.dart';
export 'fees_page1_model.dart';

class FeesPage1Widget extends StatefulWidget {
  const FeesPage1Widget({super.key});

  @override
  State<FeesPage1Widget> createState() => _FeesPage1WidgetState();
}

class _FeesPage1WidgetState extends State<FeesPage1Widget> {
  late FeesPage1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeesPage1Model());
  }
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed('BalancePage1');
                      },
                      child: Container(

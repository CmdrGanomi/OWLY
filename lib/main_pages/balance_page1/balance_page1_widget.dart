...
import 'balance_page1_model.dart';
export 'balance_page1_model.dart';

class BalancePage1Widget extends StatefulWidget {
  const BalancePage1Widget({super.key});

  @override
  State<BalancePage1Widget> createState() => _BalancePage1WidgetState();
}

class _BalancePage1WidgetState extends State<BalancePage1Widget> {
  late BalancePage1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BalancePage1Model());
  }

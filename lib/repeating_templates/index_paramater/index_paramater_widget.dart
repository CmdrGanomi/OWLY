...
import 'index_paramater_model.dart';
export 'index_paramater_model.dart';

class IndexParamaterWidget extends StatefulWidget {
  const IndexParamaterWidget({super.key});

  @override
  State<IndexParamaterWidget> createState() => _IndexParamaterWidgetState();
}

class _IndexParamaterWidgetState extends State<IndexParamaterWidget> {
  late IndexParamaterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IndexParamaterModel());
  }

...
import 'e_u_l_a_page2_model.dart';
export 'e_u_l_a_page2_model.dart';

class EULAPage2Widget extends StatefulWidget {
  const EULAPage2Widget({super.key});

  @override
  State<EULAPage2Widget> createState() => _EULAPage2WidgetState();
}

class _EULAPage2WidgetState extends State<EULAPage2Widget> {
  late EULAPage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EULAPage2Model());
  }
